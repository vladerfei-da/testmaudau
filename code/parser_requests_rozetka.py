...
class RozetkaHTMLSaver:
    def __init__(self, output_folder="rozetka_krasa"):
        self.base_url = "https://rozetka.com.ua/ua/sceen_care/c2048732/"
    ...
    def scrape_pages(self, start=92, end=92, delay_min=15, delay_max=25):
        """Основний метод"""
        print("="*70)
        print("🍷 ROZETKA HTML SAVER")
        print("="*70)
...
if __name__ == "__main__":
    saver = RozetkaHTMLSaver(output_folder="rozetka_krasa")
    
    # Завантаження сторінок 2-51
    print("📥 ЗАВАНТАЖЕННЯ СТОРІНОК 2-53\n")
    saver.scrape_pages(start=92, end=92, delay_min=15, delay_max=25)