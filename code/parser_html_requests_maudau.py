...
class RozetkaHTMLSaver:
    def __init__(self, output_folder="prybyrannia_ta_myttia"):
        self.base_url = "https://maudau.com.ua/category/zasoby-dlia-prybyrannia-ta-myttia/"
    ...
    def scrape_pages(self, start=1, end=38, delay_min=3, delay_max=10):
        """Основний метод"""
        print("="*70)
...
if __name__ == "__main__":
    saver = RozetkaHTMLSaver(output_folder=r"D:\testmaudau\prybyrannia_ta_myttia")
    
    # Завантаження сторінок 2-51
    print("📥 ЗАВАНТАЖЕННЯ СТОРІНОК \n")
    saver.scrape_pages(start=1, end=38, delay_min=3, delay_max=10) 