...
class RozetkaHTMLSaver:
    def __init__(self, output_folder="epik_krasa_fluid_oblychchia"):
        self.base_url = "https://epicentrk.ua/ua/shop/fliuidy-dlia-oblychchia/"
    ...
    def get_page_url(self, page_num):
        ...
        return f"{self.base_url}?PAGEN_1={page_num}"
    ...
    def scrape_pages(self, start=1, end=66, delay_min=3, delay_max=10):
        """Основний метод"""
        print("="*70)
        print("🍷 EPIK HTML SAVER")
        print("="*70)
        ...
        try:
            ...
            self.driver.get("https://epicentrk.ua/")
            time.sleep(5)
...
if __name__ == "__main__":
    saver = RozetkaHTMLSaver(output_folder=r"D:\testmaudau\epik_krasa_fluid_oblychchia")
    
    # Завантаження сторінок 2-51
    print("📥 ЗАВАНТАЖЕННЯ СТОРІНОК \n")
    saver.scrape_pages(start=1, end=2, delay_min=10, delay_max=20)